...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithRed:0.173 green:0.243 blue:0.314 alpha:1.000];
    }
    return self;
}
...
//    [[UIColor colorWithRed:0.906 green:0.298 blue:0.235 alpha:1.000] setStroke];
...
//    [bezierPath stroke];
    ...
    if (self.selected) {
        ...
        if (self.indicatorColor) {
            ...
            [[UIColor colorWithRed:0.102 green:0.737 blue:0.612 alpha:1.000] setStroke];
        }
